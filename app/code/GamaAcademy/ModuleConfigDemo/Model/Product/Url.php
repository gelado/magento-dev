...
class Url extends UrlCore
{
    ...
    /**
     * Url constructor.
     * @param EraserDependency $classRodrigo
    ...
    public function __construct(
        ...
        $this->classRodrigo = $classRodrigo;
        $this->pen = $pen;
        $this->eraser = $eraser;
    }
    ...
    public function getProductUrl($product, $useSid = null)
    {
        ...
        $params['anything'] = $this->classRodrigo->getRandNumber();
        $params['brand'] = $this->pen->getBrand();
        $params['eraser1_size'] = $this->eraser->getSize();

        $params['eraser2_size'] = $this->classRodrigo->getSize();
